...
?>
        ...
        <div class="spec-item spec-item-<?php echo get_the_ID() ?>">
            ...
            <div class="d-flex justify-content-end spec-item--link">
                ...
                <a href="<?php echo get_the_permalink() ?>"><img class="d-none d-lg-flex" src="<?php echo get_theme_file_uri() ?>/resources/assets/images/arrow-next.png" alt="arrow next"> Czytaj
                    dalej</a>
            </div>
        </div>
